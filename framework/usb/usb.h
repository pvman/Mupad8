...
#include "../src/system_config.h"          // Must be defined by the application

#include "../framework/usb/usb_common.h"         // Common USB library definitions
#include "../framework/usb/usb_ch9.h"            // USB device framework definitions

#if defined( USB_SUPPORT_DEVICE )
    #include "../framework/usb/usb_device.h"     // USB Device abstraction layer interface
#endif
...
#include "../framework/usb/usb_hal_pic16f1.h"            // Hardware Abstraction Layer interface
